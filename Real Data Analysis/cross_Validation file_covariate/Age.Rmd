...
y : Female, Clinic_A, Clinic_B, Clinic_C, Age

bw : 143.4, 142.9, 128.2, 83.2, 124.6


```{r}


mid_age = function(value){
  
  if (value == '0 to <18'){
    return(8.5)
  }
  else if (value == '18 to <25 yrs'){
    return(21)
  }
  else if (value == '25 to <30 yrs'){
    return(27)
    
  }
  else if (value == '30 to <35 yrs'){
    return(32)
  }
  else if (value == '35 to <40 yrs'){
    return(37)
  }
  else if (value=='40 to <45 yrs'){
    return(42)
  }
  else if (value=='45 to <55 yrs'){
    return(49.5)
  }
  else{
    return(55)
...
test_name = c('Female', 'Clinic_A', 'Clinic_B', 'Clinic_C', 'age')
bandwidth_lin = c(143.4, 142.9, 128.2, 83.2, 124.6)
...
result = check_bw(newdata = dat, column = test_name[5], q=0.5, cutoff = 350, bw_center = bandwidth_lin[1])

write.csv(result, 'Age.csv')
